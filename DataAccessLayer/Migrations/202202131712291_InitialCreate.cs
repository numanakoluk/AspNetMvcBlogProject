    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.NoteUsers", t => t.Owner_Id)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.NoteUsers", t => t.LikedUser_Id)
                .ForeignKey("dbo.Notes", t => t.Note_Id)
        ...
        {
            DropForeignKey("dbo.Notes", "Owner_Id", "dbo.NoteUsers");
            DropForeignKey("dbo.Likes", "Note_Id", "dbo.Notes");
            DropForeignKey("dbo.Likes", "LikedUser_Id", "dbo.NoteUsers");
            DropForeignKey("dbo.Comments", "Owner_Id", "dbo.NoteUsers");
